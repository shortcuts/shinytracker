(function () {
  ...
  var EXT_ITEMS = [
    { href: 'https://github.com/shortcuts/shinytracker/blob/main/CONTRIBUTING.md', label: 'Contributing' },
    { href: 'https://github.com/shortcuts/shinytracker/issues/new?labels=enhancement', label: 'Request a feature' },
    { href: 'https://github.com/shortcuts/shinytracker/issues/new?labels=bug', label: 'Report a bug' },
  ];
  ...
  var aside = '<aside class="sidebar">'
    ...
    +   '<span class="brand-name">shinytracker</span>'
    + '</a>'
    ...
    +   '<a class="gh-star" href="https://github.com/shortcuts/shinytracker" target="_blank" rel="noopener">'
  ...
  fetch('https://api.github.com/repos/shortcuts/shinytracker')
